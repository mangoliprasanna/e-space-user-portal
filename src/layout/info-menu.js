...
export default function InfoMenu() {
  const item = useSelector(state => state.browser.selectedItem) || {};
  return (
    <>
      <aside className="control-sidebar control-sidebar-light info-menu">
        <a className='pull-right' href="#" data-toggle="control-sidebar" style={{ padding: '10px' }}>
          <i className="fa fa-close" style={{ fontSize: '20px', color: 'black' }} />
        </a>
        <div className="info-menu-body">
          <i className={`${getIconFromType(item?.type)} info-menu-object-icon`} aria-hidden="true" />
